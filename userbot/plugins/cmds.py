...
DEV_IMG = "https://telegra.ph/file/d4cb43d8e4a06b25b8452.mp4"
EMOJI = "  𓄂† "
...
async def _(e):
    ...
    if DEV_IMG:
        dev_c += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 ↬ @oorrr ༗\n"
        dev_c += f"**{EMOJI}** 𝑫𝑬𝑽 𝑰𝑫 ↬ 453603108 ༗\n"
        dev_c += f"𓍹ⵧⵧⵧⵧⵧⵧⵧɴᴏᴠᴇᴍʙᴇʀⵧⵧⵧⵧⵧⵧⵧ𓍻"
