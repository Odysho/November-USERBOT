# reverse search and google search  plugin for icss
import io
import os
import re
import urllib
...
@icssbot.on(admin_cmd(outgoing=True, pattern=r"كوكل (.*)"))
@icssbot.on(sudo_cmd(allow_sudo=True, pattern=r"كوكل (.*)"))
async def gsearch(q_event):
    catevent = await edit_or_reply(q_event, "**جاري البحث في الكوكل .....**")
