...
@icssbot.on(icss_cmd(pattern="س(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="س(?: |$)(.*)", allow_sudo=True))
async def _(e):
    if e.fwd_from:
        return
...
@icssbot.on(icss_cmd(pattern="سر(?: |$)(.*)", outgoing=True))
@icssbot.on(sudo_cmd(pattern="سر(?: |$)(.*)", allow_sudo=True))
async def _(e):
    if e.fwd_from:
        return
    reply = await e.get_reply_message()
