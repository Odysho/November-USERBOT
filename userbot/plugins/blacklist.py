...
@icssbot.on(admin_cmd(pattern="منع كلمة ((.|\n)*)"))
@icssbot.on(sudo_cmd(pattern="منع كلمة ((.|\n)*)", allow_sudo=True))
...
@icssbot.on(admin_cmd(pattern="الكلمات$"))
@icssbot.on(sudo_cmd(pattern="الكلمات$", allow_sudo=True))
async def on_view_blacklist(event):
    all_blacklisted = sql.get_chat_blacklist(event.chat_id)
    OUT_STR = "𓆩 sᴏᴜʀᴄᴇ ɴᴏᴠᴇᴍʙᴇʀ - 𝑩𝑳𝑨𝑪𝑲𝑳𝑰𝑺𝑻 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n\n\n**⪼ قائمه الكلمات المحظورة :**\n"
    if len(all_blacklisted) > 0:
        for trigger in all_blacklisted:
            OUT_STR += f"⪼ {trigger} 𓆰.\n"
    else:
        OUT_STR = "𓆩 sᴏᴜʀᴄᴇ ɴᴏᴠᴇᴍʙᴇʀ - 𝑩𝑳𝑨𝑪𝑲𝑳𝑰𝑺𝑻 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n\n\n** - ◁︱لا توجد ڪلمات محظورة قم باضافة ڪلمه من خلال امر**. `.منع كلمة` 𓆰."
